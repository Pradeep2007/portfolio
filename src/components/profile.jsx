...
const Profile=()=>{
    return(
        <section
            id="home"
            className="text-gray-600 bg-slate-900 pt-16 lg:min-h-75vh"
        >
            <div className="p-5 mx-auto gap-2 flex flex-col md:pt-12 md:px-7 lg:py-20 lg:flex-row-reverse items-center min-h-fit">
                ...
                <div className="lg:flex-grow lg:pr-4 lg:mr-14 flex flex-col md:mb-0 items-center text-center xl:scale-105">
                    ...
                    >
                    Hello , I am{" "}
                    <span className="text-orange-600">{ProfileData.name}</span>
                    </h2>
                    <div
                    data-aos="zoom-in-up"
                    data-aos-duration="1500"
                ...
                <div
                    ...
                    >
                    <button className="inline-flex font-medium text-white bg-black border-2 border-white py-3 px-7 focus:outline-none hover:bg-stone-200 hover:border-orange-600 hover:text-black rounded-full text-md xl:px-10">
                    <Link
                        to="contact"
                        spy={true}
                        smooth={true}
                    ...
                    <button className="inline-flex font-medium text-white bg-orange-600 border-2 border-dark-orange py-3 px-7 focus:outline-none hover:bg-stone-200 hover:border-orange-600 hover:text-black rounded-full text-md xl:px-10">
                        Get Resume
                    </button>
                    </a>
                </div>
